...
if __name__=="__main__":
	...
	for speaker in speakers:
		...
		print speaker
		if tct<=0:
			tct=len(glob.glob('test_wavdata/'+speaker+'/*.txt'))
		for testcasefile in glob.glob('test_wavdata/'+speaker+'/*.txt'):
			...
			max_score=-9999999
			max_speaker=speaker
			for modelfile in sorted(glob.glob('train_models/train_wavdata/*.pkl')):
				print 'in for'
				print modelfile
